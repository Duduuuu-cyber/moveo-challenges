  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-10">
      <button
        ...
        className="px-4 py-2 rounded-xl glass-card text-slate-300 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed hover:bg-slate-800 transition-colors"
